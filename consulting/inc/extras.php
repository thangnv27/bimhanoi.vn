...
if ( ! function_exists( 'consulting_importer_done_function' ) ) {
	function consulting_importer_done_function() {
		...
		$theme_mods_file = get_template_directory() . '/inc/demo/theme_mods.json';
		...
		$widgets_file = get_template_directory() . '/inc/demo/widget_data.json';
		...
		if ( class_exists( 'RevSlider' ) ) {
			...
			$service_slider = get_template_directory() . '/inc/demo/service_slider.zip';
			...
			$fullscreen_main_slider = get_template_directory() . '/inc/demo/fullscreen_main_slider.zip';
...
if( ! function_exists( 'consulting_setup_options' ) ){
	function consulting_setup_options () {
		...
		$options_file = get_template_directory() . '/inc/demo/options.json';
...
if ( ! function_exists( 'consulting_get_top_bar_info' ) ) {
	function consulting_get_top_bar_info() {
		...
		for ( $i = 1; $i <= 10; $i ++ ) {
			...
			$context = 'Theme Mod';
			$key_name = 'top_bar_info_' . $i . '_office';
			$value = get_theme_mod($key_name);
			//do_action('wpml_register_single_string', $context, $key_name, $value);
			$top_bar_info_office = icl_translate($context, $key_name, $value);
			...
			$key_name = 'top_bar_info_' . $i . '_address';
			$value = get_theme_mod($key_name);
			//do_action('wpml_register_single_string', $context, $key_name, $value);
			$top_bar_info_address = icl_translate($context, $key_name, $value);
			...
			$key_name = 'top_bar_info_' . $i . '_hours';
			$value = get_theme_mod($key_name);
			//do_action('wpml_register_single_string', $context, $key_name, $value);
			$top_bar_info_hours = icl_translate($context, $key_name, $value);
			...
			$key_name = 'top_bar_info_' . $i . '_phone';
			$value = get_theme_mod($key_name);
			//do_action('wpml_register_single_string', $context, $key_name, $value);
			$top_bar_info_phone = icl_translate($context, $key_name, $value);
